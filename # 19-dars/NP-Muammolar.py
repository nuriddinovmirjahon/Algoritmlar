...
# Shunday holatlarda bizga ochko'z algoritmlar yordam beradi
...
# Agar to'g'ri yechimni topish juda ko'p vaqt (resurs) talab qilsa qoniqarli yechimni topish uchun Greedy Algorithmlarni tanlang.